...
## Поводы (жизнь портала)

В `/admin/awards` админ выбирает повод — подставляются тип, бланк и текст. Можно править перед выдачей.

Конкурс (победитель / призёр / участник), волонтёр мероприятия, спикер, актив клуба, добровольчество, экоакция, хозяин площадки, наставник, практика, форум, командный проект, медиа, спорт. Либо «свой текст».
