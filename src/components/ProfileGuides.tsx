...
const GUIDES: GuideDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'За фото растёт соцрейтинг и начисляются эко-очки в кошелёк магазина.',
    ],
  },
  {
    id: 'reliability',
  ...
  },
  {
    id: 'eco',
    title: 'Эко-очки',
    summary: 'Кошелёк магазина и оформление профиля',
    accent: '#16a34a',
    Icon: Leaf,
    module: 'eco',
    steps: [
      'Эко-очки за активность: чекин, друзья, галерея, инструктаж, вакансии, конкурсы и игры.',
      'В магазине — рамки и значки за эко-очки. Репутация (уровень участия) — отдельно, её нельзя тратить.',
