    ...
    <section className="referral-panel referral-panel--modern" aria-label="Реферальная программа">
      <div className="referral-panel__head">
        <div>
          ...
          <p className="referral-panel__lead">
            Друг регистрируется по ссылке и приходит на событие — вы оба получаете М-баллы и социум.
          </p>
        </div>
      ...
      {rulesOpen ? (
        <div className="referral-panel__rules">
          <ul>
            <li>
              Регистрация: вам до <b>{data.rewards.ECO_SIGNUP_REFERRER}</b> М-баллов, другу{' '}
              <b>{data.rewards.ECO_SIGNUP_REFEREE}</b>.
            </li>
            <li>
              Инструктаж друга: +<b>{data.rewards.ECO_INSTRUCTIONS_REFERRER}</b> М-баллов вам.
            </li>
            <li>
              Отметка на событии: +<b>{data.rewards.ECO_CHECKIN_REFERRER}</b> М-баллов вам, +
            ...
            <li>
              ...
              от М-баллов за его регистрацию и ~{Math.round((data.rewards.L2_CHECKIN_PCT || 0.15) * 100)}% от М-баллов за его
              check-in.
            </li>
            <li>
