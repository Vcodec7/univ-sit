...
export const RATING_METER_COPY = {
  ...
  ECO: {
    label: 'Кошелёк магазина',
    short: 'эко',
    tip: 'Эко-очки тратятся на стиль и карты. Репутация участия — отдельный счёт, её нельзя потратить.',
    color: '#0f766e',
  },
  LEVEL: {
    label: 'Уровень',
    short: 'Ранг',
    tip: 'Общий вклад на портале: эко-очки + стиль + коллекция',
    color: '#ea580c',
  },
} as const;
