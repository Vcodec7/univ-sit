...
const BASE: Record<string, string> = {
  ...
  'eco.owned': 'Куплено',
  'eco.equipped': 'Надето',
  'eco.toast.game': '+{n} М-баллов за игру сегодня',
  'eco.toast.view': '+{n} М-баллов за просмотр',
  'eco.toast.buy': 'Покупка оформлена',
  'games.hub.title': 'Офлайн-игры',
  'game.hub.intro': 'Рекорды на устройстве и в рейтинге сайта. До 5 М-баллов в день за игру.',
  'game.start': 'Играть',
...
const ELITE: Record<string, string> = {
  ...
  'eco.toast.game': '+{n} к капиталу за партию',
...
const SOCHI: Record<string, string> = {
  ...
  'eco.owned': 'Уже есть',
  'eco.equipped': 'На тебе',
  'eco.toast.game': '+{n} М-баллов за игру сегодня — огонь',
  'eco.toast.view': '+{n} М-баллов за просмотр',
  'eco.toast.buy': 'Готово, красота',
  'game.hub.title': 'Офлайн-игры',
  'game.hub.intro': 'Рекорды на устройстве и в рейтинге. До 5 М-баллов в день — как прогулка у моря.',
  'game.start': 'Погнали',
...
const YOUTH: Record<string, string> = {
  ...
  'nav.quick': 'Быстро',
  'eco.title': 'М-баллы',
  'eco.spend': 'Копи М-баллы и апгрейдь стиль — рамки, голоса, темы.',
  'eco.buy': 'Беру',
  'eco.equip': 'Надеть',
  'eco.unequip': 'Снять',
  'eco.owned': 'Есть',
  'eco.equipped': 'На тебе',
  'eco.toast.game': '+{n} М-баллов за игру — красава',
  'eco.toast.view': '+{n} М-баллов за просмотр',
  'eco.toast.buy': 'Забрали',
  'game.hub.title': 'Мини-игры',
  'game.hub.intro': 'Рекорды тут и в рейтинге. До 5 М-баллов в день за игру.',
  'game.start': 'Старт',
