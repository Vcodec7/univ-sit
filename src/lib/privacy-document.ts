...
Цели: личный кабинет; заявки и мероприятия; конкурсы и вакансии для авторизованных участников; портфолио; мини-игры; магазин оформления за М-баллы; email-уведомления; друзья и сообщения; гид по местам Сочи; безопасность аккаунта; Яндекс.Метрика только после согласия на аналитические cookie; ответы регуляторам и субъектам ПДн.
